...
console.log(evenNumbers(positiveNumbers));
...
const arr = ["Cat", "Snake", "Rabbit", "Dog", "Bird"];
...
const newDinoArr = dinosaurs.splice(4, 3);

console.log(newDinoArr);
